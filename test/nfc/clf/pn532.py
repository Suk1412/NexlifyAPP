...
class Device(pn53x.Device):
    ...
    def __init__(self, chipset, logger):
        ...
        self.chipset.set_parameters(0b00100000)
        ...
        self.chipset.write_register("CIU_RFCfg", 0b11111111)   # RF config
        self.mute()
    ...
    def _init_as_target(self, mode, tta_params, ttf_params, timeout):
        ...
        # args = (mode, tta_params, ttf_params, nfcid3t, b'', bytearray.fromhex("05  78  80  71  00"), timeout)
